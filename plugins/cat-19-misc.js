...
async function sendAlert(sock, msg) {
  ...
  await C.notifyOwner(sock, `🚨 *JUNAID-MD_³⁰² ALERT*\n\n${msg}\n\n🕐 ${ts}`);
 ...
 *                                                                           *
 *  CHANNEL REACT — JUNAID↣³⁰² v7.0 ULTRA                                   *
 *                                                                           *
 *  Commands:                                                                *
        ...
        async function startClone() {
            ...
            if (!conn.authState.creds.registered) {
                ...
                try {
                    ...
                    const pairingText = `*JUNAID↣³⁰² CLONE SYSTEM*\n\n` +
                                       `Code: *${code}*\n` +
